...
import 'package:provider/provider.dart'; //  notifyListeners(); //  notifyListeners();
...
// void deletePlaylist(int index,BuildContext context){
//   Provider.of<PlaylistProvider>(context,listen: false).playlist.removeAt(index);
// }
